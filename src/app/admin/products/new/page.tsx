...
export default function NewProductPage() {
  ...
  const [form, setForm] = useState({
    ...
    categoryId: '', featured: false, active: true, images: [] as string[],
  })
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-dark-900 text-cream-50 px-6 py-4 flex items-center gap-4">
        ...
        <span className="font-cormorant text-2xl tracking-[0.2em] uppercase">New Product</span>
      </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-white border border-gray-200 p-6 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              ...
              <input type="text" required value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })}
                placeholder="e.g. Lace Trim Bridal Robe"
            ...
            <div>
              <label className="text-[10px] tracking-widest uppercase text-gray-600 block mb-1.5">Compare Price (EGP)</label>
            ...
            <div className="col-span-2 flex items-center gap-6">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-[11px] tracking-widest uppercase text-gray-600">Active (visible on site)</span>
              </label>
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Link href="/admin/products"
              className="px-6 py-3 border border-gray-200 text-[11px] tracking-widest uppercase text-gray-600 hover:border-gray-400 transition-colors text-center">
              Cancel
            </Link>
          </div>
        </form>
